 ...
 * To change global log tag: L.LOG_TAG = "My MainApplication";
...
public final class L {
    ...
    public static String LOG_TAG = GlobalSettings.getLogTag();
    ...
    public static void e(String message, Throwable cause) {
        if (GlobalSettings.isDebugMode() || 1==1) {
     ...
     * necessarily an ic_toast_error. Such a condition should only be logged by a module that reasonably believes that it
     ...
     * enough ic_toast_information about what is going on about your component. If your debug logs are dominating the log then
